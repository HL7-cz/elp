...
<figure>
  {% include elp_CIM-cs.svg %}
</figure>

###### Hlavička dokumentu

<figure>
  {% include elpHead_CIM-cs.svg %}
</figure>

###### Tělo dokumentu

<figure>
  {% include elpBody_CIM-cs.svg %}
</figure>
...
2. komplexní fyzikální vyšetření, a to včetně orientačního vyšetření sluchu, zrakové ostrosti a barvocitu, orientačního vyšetření zorného pole a rovnováhy a orientačního neurologického vyšetření, a to s cíleným zaměřením na zjištění příznaků nemoci uvedené v `příloze č. 3 k vyhlášce č. 277/2004 Sb.`.
